...
public class Cargo_Truck_2 : MonoBehaviour
{
    ...
    private void frontSenors()
    {
        ...
        if(Physics.Raycast(frontSensorsRay, out hit, sensorLength))
        {
            ...
            CarSensorsManager.Current.reportDetection(Truck.CargoTruck_2, SensorsTypes.FrontCenterSensor);
            
        }
        else if(CarSensorsManager.Current.isReported(Truck.CargoTruck_2, SensorsTypes.FrontCenterSensor))
        {
           Debug.Log("clearing is reported"); 
           CarSensorsManager.Current.unreportDetection(Truck.CargoTruck_2, SensorsTypes.FrontCenterSensor);
        ...
        if(Physics.Raycast(frontSensorsRay, out hit, sensorLength))
        {
            CarSensorsManager.Current.reportDetection(Truck.CargoTruck_2, SensorsTypes.FrontCenterRightSensor);
           
            Debug.DrawRay(frontSensorsStartPos, transform.forward*hit.distance, Color.red);
        }
        else if(CarSensorsManager.Current.isReported(Truck.CargoTruck_2, SensorsTypes.FrontCenterRightSensor))
        {
            CarSensorsManager.Current.unreportDetection(Truck.CargoTruck_2, SensorsTypes.FrontCenterRightSensor);
        }
        ...
        if(Physics.Raycast(frontSensorsRay, out hit, sensorLength))
        {
            CarSensorsManager.Current.reportDetection(Truck.CargoTruck_2, SensorsTypes.FrontCenterLeftSensor);
           
            Debug.DrawRay(frontSensorsStartPos, transform.forward*sensorLength, Color.red);    
        }
        else if(CarSensorsManager.Current.isReported(Truck.CargoTruck_2, SensorsTypes.FrontCenterLeftSensor))
        {
            CarSensorsManager.Current.unreportDetection(Truck.CargoTruck_2, SensorsTypes.FrontCenterLeftSensor);
        }
        else
        {
            Debug.DrawRay(frontSensorsStartPos, transform.forward*sensorLength, Color.green);
    ...
    private void rightFrontSensors()
    {
        ...
        {
            CarSensorsManager.Current.reportDetection(Truck.CargoTruck_2, SensorsTypes.RightFrontCenterSensor);
           
            Debug.DrawRay(rightSensorsStartPosition, transform.right*hit.distance, Color.red);
        }
        else if(CarSensorsManager.Current.isReported(Truck.CargoTruck_2, SensorsTypes.RightFrontCenterSensor))
        {
            CarSensorsManager.Current.unreportDetection(Truck.CargoTruck_2, SensorsTypes.RightFrontCenterSensor);
        ...
        if(Physics.Raycast(rightSensorsRay, out hit, sensorLength))
        {
            CarSensorsManager.Current.reportDetection(Truck.CargoTruck_2, SensorsTypes.RightFrontCenterRightSensor);
        ...
        else if(CarSensorsManager.Current.isReported(Truck.CargoTruck_2, SensorsTypes.RightFrontCenterRightSensor))
        {
            CarSensorsManager.Current.unreportDetection(Truck.CargoTruck_2, SensorsTypes.RightFrontCenterRightSensor);
        ...
        if(Physics.Raycast(rightSensorsRay, out hit, sensorLength))
        {
            CarSensorsManager.Current.reportDetection(Truck.CargoTruck_2, SensorsTypes.RightFrontCenterLeftSensor);
           
            Debug.DrawRay(rightSensorsStartPosition, Quaternion.AngleAxis(-sensorsAngle, transform.up)*transform.right*hit.distance);
        }
        else if(CarSensorsManager.Current.isReported(Truck.CargoTruck_2, SensorsTypes.RightFrontCenterLeftSensor))
        {
            CarSensorsManager.Current.unreportDetection(Truck.CargoTruck_2, SensorsTypes.RightFrontCenterLeftSensor);
        }
        else
        {
    ...
    private void rightBackSensors()
    {
        ...
        {
            CarSensorsManager.Current.reportDetection(Truck.CargoTruck_2, SensorsTypes.RightBackCenterSensor);
            Debug.DrawRay(rightBackSensorsStartPos, transform.right*hit.distance, Color.red);
        }
        else if(CarSensorsManager.Current.isReported(Truck.CargoTruck_2, SensorsTypes.RightBackCenterSensor))
        {
            CarSensorsManager.Current.unreportDetection(Truck.CargoTruck_2, SensorsTypes.RightBackCenterSensor);
        }
        else
        {
    ...
    private void backSensors()
    {
        ...
        if(Physics.Raycast(backSensorsRay, out hit, sensorLength))
        {
          ...
          CarSensorsManager.Current.reportDetection(Truck.CargoTruck_2, SensorsTypes.BackCenterSensor);      
        }
        else if(CarSensorsManager.Current.isReported(Truck.CargoTruck_2, SensorsTypes.BackCenterSensor))
        {
            CarSensorsManager.Current.unreportDetection(Truck.CargoTruck_2, SensorsTypes.BackCenterSensor);
        }
        else
        {
        ...
        if(Physics.Raycast(backSensorsRay, out hit, sensorLength))
        {
            ...
            CarSensorsManager.Current.reportDetection(Truck.CargoTruck_2, SensorsTypes.BackCenterRightSensor);
        }
        else if(CarSensorsManager.Current.isReported(Truck.CargoTruck_2, SensorsTypes.BackCenterRightSensor))
        {
            CarSensorsManager.Current.unreportDetection(Truck.CargoTruck_2, SensorsTypes.BackCenterRightSensor);
        }
        else
        {
        ...
        {
            Debug.DrawRay(backSensorsStartPos, -transform.forward*hit.distance, Color.red);
            CarSensorsManager.Current.reportDetection(Truck.CargoTruck_2, SensorsTypes.BackCenterLeftSensor);
        }
        else if(CarSensorsManager.Current.isReported(Truck.CargoTruck_2, SensorsTypes.BackCenterLeftSensor))
        {
            CarSensorsManager.Current.unreportDetection(Truck.CargoTruck_2, SensorsTypes.BackCenterLeftSensor);
        } 
        else
        {
            Debug.DrawRay(backSensorsStartPos, -transform.forward*sensorLength, Color.green);
